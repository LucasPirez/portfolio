  ...
  return (
    <>
      ...
      >
        ...
        <div className="fixed top-[0.50rem]  left-4 m-4 z-20 flex ">
          <select
            className="text-xs md:text-base bg-zinc-900 rounded-2xl px-2 border-2 border-cyan-700 cursor-pointer p-1  hover:border-2  hover:scale-105 transition-all duration-300 hover:border-cyan-700 text-slate-200  mr-2 dark:hover:border-cyan-700 dark:text-slate-200 h-8"
