        ...
        <div className=" text-slate-100 dark:text-slate-300  text-lg sm:text-3xl md:text-5xl text-center  font-mono z-10">
          ...
          <div className="flex justify-center mt-4 lg:mt-8">
            <a
              ...
              border-[2px] border-cyan-700 p-2  text-sm md:text-lg  lg:text-xl lg:p-3  rounded-md hover:bg-cyan-600 bg-slate-800  hover:border-cyan-800 transition  ease-out duration-300 dark:bg-zinc-800 dark:border-cyan-600 dark:hover:bg-cyan-800`}
            >
            ...
            <a
              ...
              className="group flex  border-2  hover:bg-slate-800   hover:border-cyan-600 border-transparent text-sm md:text-lg  lg:text-xl items-center rounded-md px-1  ml-4 "
            >
              <span>
                <GmailIcon className="scale-75" />
              </span>
              <span className=" group-hover:scale-100 scale-0 transition-all origin-left ">
                Send Email
              </span>
            </a>
          </div>
