  ...
  return (
    ...
    >
      <div className="w-[100%]  h-[5vw] relative ">
        <div className=" absolute left-0 top-0 pb-1  border-l-[51vw] border-r-[51vw] border-t-[5vw] border-t-transparent border-r-transparent border-l-slate-800"></div>
        <div className=" absolute right-0 top-0 pb-1   border-l-[49vw] border-r-[49vw] border-t-[5vw] border-t-transparent border-l-transparent border-r-slate-800"></div>
      </div>
      {animationStart && (
        <div className="flex px-4 lg:flex-row flex-col relative w-full  h-auto bg-slate-800 items-center  lg:justify-around pb-4">
